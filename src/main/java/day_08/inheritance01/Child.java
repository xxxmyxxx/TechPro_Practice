...
//        Math.abs(1);
        ...
        obj1.method3();
        System.out.println("obj1.yas = " + obj1.yas); // child class indan obje uretildigi icin ilk once bu classta "yas" i ariyor

        Parent obj2 =new Parent();
        System.out.println("obj2.yas = " + obj2.yas);

        // Java veriable ararken her zaman yukari dogru bakar yani ilk kendi classina bakar
